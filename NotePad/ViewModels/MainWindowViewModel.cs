...
namespace NotePad.ViewModels {
    public class MainWindowViewModel: ViewModelBase {
        private readonly ObservableCollection<ItemFile> fileList = new();
        public ObservableCollection<ItemFile> FileList { get => fileList; }
        ...
        private void LoadDisks() {
            ...
            foreach (DriveInfo drive in drives)
                fileList.Add(new ItemFile(drive.Name == sys_d ? SysDrive : Drive, drive.Name));
        }
        private void LoadDir() {
            ...
            fileList.Clear();
            fileList.Add(new ItemFile(BackFolder, ".."));
            foreach (var name in dirs) fileList.Add(new ItemFile(Folder, name));
            foreach (var name in files) fileList.Add(new ItemFile(FILE, name));
        }
        ...
        private void SelectItem(ItemFile item) {
            if (item == null) return;
            FileBox = item.Name;
            UpdButtonMode();
        }
        ...
        string contentBox = "";
        string fileBox = "";
        ItemFile selectedItem = new(FILE, "?");
        ...
        public ItemFile SelectedItem { get => selectedItem; set { selectedItem = value; SelectItem(value); } }
